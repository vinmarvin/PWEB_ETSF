            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="{{asset('adminui/img/avatar-1.jpg')}}" alt="..." class="img-fluid">
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="{{asset('adminui/img/avatar-4.jpg')}}" alt="..." class="img-fluid">
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="{{asset('adminui/img/avatar-6.jpg')}}" alt="..." class="img-fluid">
